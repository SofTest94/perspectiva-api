...
var UserSchema = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('usersPers')];
    ...
    var UserSchema = _classThis = /** @class */ (function () {
        function UserSchema_1() {
    ...
    __setFunctionName(_classThis, "UserSchema");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __id_decorators = [(0, typeorm_1.ObjectIdColumn)()];
        ...
        UserSchema = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserSchema = _classThis;
}();
